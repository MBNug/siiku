...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('triwulan2_p_t_n_b_h_s', function (Blueprint $table) {
            ...
            $table->enum('statusterakhir', ['Tidak Tercapai', 'Tercapai', 'Melampaui Target', 'Belum Diupdate', 'Sedang Diproses'])->nullable()->default('Belum Diupdate');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('triwulan2_p_t_n_b_h_s');
    }
};
