        ...
        if ($levelakun->level <2){
            if($jmlbelumdisetujui!=0){
                ...
                if($jmlbelumdisetujui>0){  
                    for($i=0; $i<$jmldept;$i++){
                        $kode=$dept[$i]->kode;
                        $jmlapprovetarget = Target::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', '1')->count();
                        $jmlrejecttarget = Target::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', '3')->count();
                        $jmlwaitingtarget = Target::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', '2')->count();
                ...
                if($triwulan->triwulan == '1'){
                    ...
                    for($i=0; $i<$jmldept;$i++){
                        ...
                        if($jmltotalrealisasidept>0){
                            ...
                            $jmlbelumdiupdate = Triwulan1::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', 'Belum Diupdate')->count();
                ...
                elseif($triwulan->triwulan == '2'){
                    for($i=0; $i<$jmldept;$i++){
                        ...
                        if($jmltotalrealisasidept>0){
                            ...
                            $jmlbelumdiupdate = Triwulan2::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', 'Belum Diupdate')->count();
                            $totalketercapaian = $jmltercapai + $jmlmelampauitarget;
                        }else{
                            $jmltidaktercapai = '-';
                            $jmltercapai = '-';
                ...
                elseif($triwulan->triwulan == '3'){
                    for($i=0; $i<$jmldept;$i++){
                        ...
                        if($jmltotalrealisasidept>0){
                            ...
                            $jmlbelumdiupdate = Triwulan3::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', 'Belum Diupdate')->count();
                            $totalketercapaian = $jmltercapai + $jmlmelampauitarget;
                        }else{
                            $jmltidaktercapai = '-';
                            $jmltercapai = '-';
                ...
                elseif($triwulan->triwulan == '4'){
                    for($i=0; $i<$jmldept;$i++){
                        ...
                        if($jmltotalrealisasidept>0){
                            ...
                            $jmlbelumdiupdate = Triwulan4::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', 'Belum Diupdate')->count();
                            $totalketercapaian = $jmltercapai + $jmlmelampauitarget;
                        }else{
                            $jmltidaktercapai = '-';
                            $jmltercapai = '-';
                ...
                elseif($triwulan->triwulan == '0'){
                    ...
                    for($i=0; $i<$jmldept;$i++){
                        ...
                        if($jmltotalrealisasidept>0){
                            ...
                            $jmlbelumdiupdate = Realisasi::where('kode', 'like', '%'.$actConfig->tahun)->where('kode', 'like', $kode.'%')->where('status', '=', 'Belum Diupdate')->count();
                            $totalketercapaian = $jmltercapai + $jmlmelampauitarget;
                        }else{
                            $jmltidaktercapai = '-';
                            $jmltercapai = '-';
    ...
    public function gantiData(Request $request){
        ...
        if ($levelakun->level <2){
            ...
            if($jmlbelumdisetujui!=0){
                ...
                return view('renstra.dashboard', compact('err','title','triwulan','targetdisetujui','targetditolak','targetmenunggupersetujuan','namadepartemen','jmlbelumdisetujui','jmlindikator','indikator'))->with([
                    'user'=> Auth::user()
                ]);
            }else{ //fase pengisian Realisasi
                $jmltriwulan1 = Triwulan1::count();
                ...
                if($triwulan->triwulan == '1'){
                    // dd($triwulan->triwulan);
                    if ($jmltriwulan1==0){
                        return view('renstra.dashboard', compact('actConfig','err','title','triwulan','jmlbelumdisetujui','jmlindikator','jmltriwulan1','check','indikator'))->with([
                            'user'=> Auth::user()
                        ]);
                    }
                    for($i=0; $i<$jmldept;$i++){
                ...
                return view('renstra.dashboard', compact('actConfig','err','title','triwulan','jmlbelumdisetujui','jmlindikator','ketercapaiantargetdept','jmltriwulan1','ketercapaianpertriwulan','namadept','check','indikator'))->with([
                    'user'=> Auth::user()
                ]);
            }
        }else{//departemen
