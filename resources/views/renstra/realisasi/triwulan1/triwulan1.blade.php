...
<div class="container">
  ...
  <div class="row">
    <div class="row">
        <div class="col-6">
            <a class="btn" href="{{ route('renstra.realisasidepartemen', [$renstradept, '1']) }}" style="background-color: #17356d;color:white">Triwulan 1</a>
        ...
        <div class="col-4">
            @if ($user->level == 1)
                <a class="btn" href="{{ route('renstra.realisasi.alertakhiritriwulan', [$renstradept, $triwulan->triwulan]) }}" style="background-color: #17356d;color:white">Akhiri Triwulan 1</a>
            @endif
            
            <a href="{{ route('renstra.realisasi.download', [$renstradept, $triwulan->triwulan])}}" class="btn btn-primary">Download PDF Triwulan 1</a>
        </div>
        @else
        <div class="col-1"></div>
        <div class="col-3">
