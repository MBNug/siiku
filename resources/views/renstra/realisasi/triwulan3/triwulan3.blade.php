  ...
  <div class="row">
    <div class="row">
        <div class="col-6">
            ...
            <a @if ($actTri->triwulan == '2' || $actTri->triwulan == '1' || $actTri->triwulan == '0' ) class="btn disabled" @else class="btn" @endif href="{{ route('renstra.realisasidepartemen', [$renstradept, '3']) }}" style="background-color: #17356d;color:white">Triwulan 3</a>
                    ...
                    <table class="table table-hover datatable">
                        <thead>
                            <tr>
                                ...
                                <th>Keterangan</th>
                                <th>Target</th>
                                <th>Status Realisasi Triwulan 2</th>
