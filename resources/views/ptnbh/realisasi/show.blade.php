...
<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="container mt-3 mb-2">
            ...
            <div class="row">
                <div class="col-2">
                    <a class="btn mb-2" href="{{ route('ptnbh.realisasi.form', [$departemen->kode, $triwulan->triwulan, $realisasi->kode]) }}" style="background-color: #17356d;color:white"><i class="fa-solid fa-pen-to-square"></i>
