  ...
  <div class="row">
    <div class="row">
        <div class="col-6">
            ...
            <a class="btn" href="{{ route('ptnbh.realisasidepartemen', [$ptnbhdept, '2']) }}" style="background-color: #17356d;color:white">Triwulan 2</a>
        ...
        <div class="col-4">
            <a class="btn" href="{{ route('ptnbh.realisasi.alertakhiritriwulan', [$ptnbhdept, $triwulan->triwulan]) }}" style="background-color: #17356d;color:white">Akhiri Triwulan 2</a>
            <a href="{{ route('ptnbh.realisasi.download', [$ptnbhdept, $triwulan->triwulan])}}" class="btn btn-primary">Download PDF Triwulan 2</a>
        </div>
        @else
        <div class="col-1"></div>
        <div class="col-3">
